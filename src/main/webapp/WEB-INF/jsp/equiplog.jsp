...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">材料记录管理</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">材料记录列表</div>
                    <!-- /.panel-heading -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger btn-xs"
                                       onclick="deleteConsume(${row.ecode})">删除 </a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    ...
                    <div class="col-md-12 text-right">
                        <kahen:page url="${pageContext.request.contextPath }/equipLog/list.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
...
<script type="text/javascript">
    // 删除材料
    function deleteConsume(ecode) {
        if (confirm('确实要删除该材料吗?')) {
            $.post("<%=basePath%>equipLog/deleteequiplog.action", {"ecode": ecode},
                function (data) {
                    if (data == "OK") {
                        alert("记录删除成功！");
