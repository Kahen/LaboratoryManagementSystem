        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">新建用户信息</div>
                    <div>
                        <form id="new_user_form" class="form-group" method="post">
                            <table class="col-sm-10">
                                <tr><label for="id">用户账号</label><input type="text" class="form-control" id="id"
                                                                       placeholder="用户账号" name="id"/>
                                </tr>
                                <tr><label for="username">用户名称</label><input type="text" class="form-control"
                                                                             id="username" placeholder="用户名称"
                                                                             name="username"/></tr>
                                <tr><label for="password">用户密码</label><input type="text" class="form-control"
                            ...
                            <br>
                            <label for="usertype">用户身份</label><select class="form-control" id="usertype"
                                                                      name="usertype">
                            ...
                            <div class="modal-footer">
                                <a href="${pageContext.request.contextPath }/admin/list.action" class="btn btn-default">返回</a>
                                <a>
                                    <button class="btn btn-primary" type="submit" onclick="createUser()">创建</button>
                                </a>
                            </div>
                        </form>
                    </div>
